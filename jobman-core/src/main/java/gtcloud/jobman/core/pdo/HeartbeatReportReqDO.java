...
public class HeartbeatReportReqDO extends Message implements FreezerJSON
{
    ...
    public HeartbeatReportReqDO(HeartbeatReportReqDO other) {
        this.copyFrom(other);
    }
    ...
    public void copyFrom(Freezable other) {
        ...
        HeartbeatReportReqDO from = (HeartbeatReportReqDO)other;
    ...
    public Freezable makeClone() {
        HeartbeatReportReqDO o = new HeartbeatReportReqDO();
        o.copyFrom(this);
        return o;
    }
